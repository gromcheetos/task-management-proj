  document.addEventListener('DOMContentLoaded', (event) => {
       ...
       const allBoardsCheckbox = document.querySelector("input[name='boardName'][value='all']");
       const boardNameCheckboxes = document.querySelectorAll("input[name='boardName']:not([value='all'])");
       ...
       const allTasksCheckbox = document.querySelector("input[name='priority'][value='all']");
       const priorityCheckboxes = document.querySelectorAll("input[name='priority']:not([value='all'])");
   ...
   document.getElementById("boardNameFilter").addEventListener("submit", function(event) {
       ...
       if (allBoardsCheckbox && allBoardsCheckbox.checked) {
           ...
           const boardNameInputs = document.querySelectorAll("input[name='boardName']:checked");
        ...
        fetch(`/board/filter/boardName?${params.toString()}`, {
            method: 'GET',
            headers: {
